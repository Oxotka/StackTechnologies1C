...
1. Позволяет экономит время разработчика на создание форм
2. В таблице можно делать Иерархию
3. Гибкая настройка свойств элементов
4. Легкий и быстрый старт
...
Быстрое создание прототипов с помощью силы Искусственного интеллекта. Привычный синтаксис Markdown.
...
1. Быстрый старт - <https://crimsongoldteam.github.io/md_design/#/БыстрыйСтарт>
2. Мастерим формы с искусственным интеллектом - <https://infostart.ru/1c/articles/2331345/>
...
Это инструменты от вендора, которые позволяют готовитgirь и выполнять тесты. 1С:Сценарное тестирование используется для тестирования типовой конфигурации 1С:Бухгалтерия предприятия.
