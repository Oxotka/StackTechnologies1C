...
**С чего начать:**
Изучите основные возможности платформы: конфигуратор, объекты метаданных, язык 1С.
Пройдите вводный курс по платформе (онлайн или очно).

**Материалы:**

1. Сборники официальных вопросов с примерами решений.
2. Видеокурсы «1С:Учебный центр №1».
3. Мобильный тренажер для повторения вопросов на ходу.
4. Пробные тесты и электронные пособия на edu.1c.ru.
...
Формат: задачи по учёту, бизнес‑процессам и расчётам за 4 часа.

**С чего начать:**

Накопите практику в реальных проектах: настройка документооборота, обработки.
Решайте лабораторные задания из официальных методичек.

**Материалы:**

1. Официальные очные и онлайн‑курсы по выбранной конфигурации.
2. Интерактивные вебинары и разборы практических кейсов.
3. Статьи и разборы задач на Infostart.ru и Telegram‑чатах.
...
Фокусируется на внедрении и сопровождении, аналитике бизнес‑процессов.
Формат: создание типовых конфигураций для отраслей, кейс‑задачи.

**С чего начать:**

Освойте методы бизнес‑анализа: диаграммы, постановку требований.
Практикуйтесь в разработке шаблонов для торговли, производства, ERP.

**Материалы:**

1. Курсы по «1С:ERP Управление предприятием» и другим отраслевым решениям.
2. Документация по проектированию и методические рекомендации 1С.
3. Обмен кейсами в профильных конференциях (Инфостарт, семинары 1С).

**Советы по подготовке:**

1. Работайте над живыми задачами: настройка учёта, интеграционные сценарии
2. Приготовьте портфолио проектов — это пригодится при защите
3. Используйте междисциплинарные навыки: коммуникации с клиентом, аналитика

[В начало](#стек-технологий-для-1с)

### 1С:Эксперт

Высший статус: глубокая разработка, оптимизация, нестандартные решения.
Формат: сложные практические задания и защита проектов перед комиссией.

**С чего начать:**

1. Углубитесь в архитектуру: СУБД (PostgreSQL), производительность, индексы.
2. Разрабатывайте интеграционные решения и модули под уникальные задачи.

**Материалы:**

1. «Настольная книга 1С:Эксперта» по технологическим вопросам.
2. Продвинутые курсы и мастер‑группы: Linux, PostgreSQL, микросервисы.
3. Профессиональные конференции и экспертные семинары.

**Советы по подготовке:**

1. Создайте собственный проект: от требования до запуска и поддержки.
2. Тренируйтесь в оптимизации производительности на реальных базах.
3. Подготовьте презентацию проекта и отработайте защиту перед коллегами.
