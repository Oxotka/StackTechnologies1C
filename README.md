...
Это инструменты от вендора, который позволяют готовить и выполнять тесты. Используется для тестирования типовой конфигурации 1С:Бухгалтерия предприятия.
...
Прекрасный набор инструментов для тестирования прикладных решений. Пользуется большой популярностью в среде 1С.
